...
@Entity(tableName = "WeatherHour",foreignKeys = @ForeignKey(entity = Location.class,
        parentColumns = "Key",
...
public class WeatherHour {
    ...
    public WeatherHour(int key, String cityKey, String weatherIcon, String weatherText, String mobileLink, String isDayTime, Date localObservationDateTime, String temperature, String temperatureUnit, String probability) {
        this.key = key;
        CityKey = cityKey;
