...
public class WeatherCustomView extends View {
    private static final String LOG_TAG = WeatherCustomView.class.getSimpleName();

    public WeatherCustomView(Context context) {
        super(context);
    }

    public WeatherCustomView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public WeatherCustomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    private WeatherCustomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
